...
///@param func is the function that takes a char and return an int.
///This function is supposed to return either 1 if layer handled the character.
///Or 0 to keep dispatching to below layers.
///@param priority is a priority used for the layer.
///The bigger the priority the higher the layer is in the chain, and the first-tier it gets the character dispatched to it.
...
///@param chr is the character to dispatch.
